...
#define OV5640_Width 280  // 图像长度
#define OV5640_Height 210 // 图像宽度

// 1. 定义要显示的画面大小，数值一定要能被4整除！！
// 2. RGB565格式下，最终会由DCMI将OV5640输出的4:3图像裁剪为适应屏幕的比例
// 3. JPG模式下，数值一定要能被8整除！！
#define Display_Width OV5640_Width   // 图像长度
#define Display_Height OV5640_Height // 图像宽度

#define Display_BufferSize Display_Width *Display_Height / 4 // DMA传输数据大小（32位宽）
